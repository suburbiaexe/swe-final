...
// @ts-ignore
export const LocationAutocomplete = ({ textFieldProps, ...props }) => {
            ...
            <Autocomplete
                ...
                onChange={
                    (e: any, value: any) => {
                        ...
                        console.log("value of location autocomplete: " + value.label)
                        // exportedSetItemCategory(value.enumString)
                    }
                }
                ...
                getOptionLabel={(option: {label:string,enumString:string}) => option.label || '' }
                ...
                renderInput={ (props: JSX.IntrinsicAttributes) => (
                    <TextField {...props} {...textFieldProps}
                               helperText={error
                                            ? helperText
                                            : "If location is not on this list or off campus, select the \"Other\" option"}
                               error={error} />
                )}
            />
        </>
