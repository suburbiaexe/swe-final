...
export const ItemDescriptionTextField: React.FC<FieldProps & TextFieldProps> = props => {
        ...
        <>
            <TextField
                ...
                helperText={((isTouched || errorMessage)
                    ? errorMessage
                    : "")}
                    // : "Describe the item as if you were describing it to a friend"}

                // (!errorMessage && helperText) ?? ((isTouched || errorMessage) ? errorMessage : undefined)}
